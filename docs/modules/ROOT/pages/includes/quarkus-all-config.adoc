...
a|icon:lock[title=Fixed at build time] [[quarkus-langchain4j-mcp_quarkus-langchain4j-mcp-enabled]] [.property-path]##link:#quarkus-langchain4j-mcp_quarkus-langchain4j-mcp-enabled[`+++quarkus.langchain4j.mcp.enabled+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.langchain4j.mcp.enabled+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
Whether MCP integration is enabled. If disabled, no MCP clients, registry clients, ToolProvider or MCP health check will be registered.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_LANGCHAIN4J_MCP_ENABLED+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_LANGCHAIN4J_MCP_ENABLED+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++true+++`
...
a| [[quarkus-langchain4j-mcp_quarkus-langchain4j-mcp-tracing-enabled]] [.property-path]##link:#quarkus-langchain4j-mcp_quarkus-langchain4j-mcp-tracing-enabled[`+++quarkus.langchain4j.mcp.tracing.enabled+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.langchain4j.mcp.tracing.enabled+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
Whether tracing is enabled for MCP clients. Requires the OpenTelemetry extension to be present.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_LANGCHAIN4J_MCP_TRACING_ENABLED+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_LANGCHAIN4J_MCP_TRACING_ENABLED+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++true+++`
...
a|icon:lock[title=Fixed at build time] [[quarkus-langchain4j-mcp_quarkus-langchain4j-mcp-client-name-enabled]] [.property-path]##link:#quarkus-langchain4j-mcp_quarkus-langchain4j-mcp-client-name-enabled[`+++quarkus.langchain4j.mcp."client-name".enabled+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.langchain4j.mcp."client-name".enabled+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_LANGCHAIN4J_MCP__CLIENT_NAME__ENABLED+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_LANGCHAIN4J_MCP__CLIENT_NAME__ENABLED+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++true+++`
...
a| [[quarkus-langchain4j-mcp_quarkus-langchain4j-mcp-client-name-cache-resource-list]] [.property-path]##link:#quarkus-langchain4j-mcp_quarkus-langchain4j-mcp-client-name-cache-resource-list[`+++quarkus.langchain4j.mcp."client-name".cache-resource-list+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.langchain4j.mcp."client-name".cache-resource-list+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
Whether to cache the resource and resource template lists obtained from the MCP server. When set to true (the default), the lists are cached until the server notifies of changes or the cache is manually evicted. When false, the client always fetches fresh lists from the server. This is useful when using MCP servers that don't support resource list change notifications.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_LANGCHAIN4J_MCP__CLIENT_NAME__CACHE_RESOURCE_LIST+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_LANGCHAIN4J_MCP__CLIENT_NAME__CACHE_RESOURCE_LIST+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|

a| [[quarkus-langchain4j-mcp_quarkus-langchain4j-mcp-client-name-cache-prompt-list]] [.property-path]##link:#quarkus-langchain4j-mcp_quarkus-langchain4j-mcp-client-name-cache-prompt-list[`+++quarkus.langchain4j.mcp."client-name".cache-prompt-list+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.langchain4j.mcp."client-name".cache-prompt-list+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
Whether to cache the prompt list obtained from the MCP server. When set to true (the default), the prompt list is cached until the server notifies of changes or the cache is manually evicted. When false, the client always fetches a fresh prompt list from the server. This is useful when using MCP servers that don't support prompt list change notifications.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_LANGCHAIN4J_MCP__CLIENT_NAME__CACHE_PROMPT_LIST+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_LANGCHAIN4J_MCP__CLIENT_NAME__CACHE_PROMPT_LIST+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|

a| [[quarkus-langchain4j-mcp_quarkus-langchain4j-mcp-client-name-auto-health-check]] [.property-path]##link:#quarkus-langchain4j-mcp_quarkus-langchain4j-mcp-client-name-auto-health-check[`+++quarkus.langchain4j.mcp."client-name".auto-health-check+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.langchain4j.mcp."client-name".auto-health-check+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
Whether the MCP client should perform health checks regularly and try to reconnect immediately if a connection issue is detected. The default is true.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_LANGCHAIN4J_MCP__CLIENT_NAME__AUTO_HEALTH_CHECK+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_LANGCHAIN4J_MCP__CLIENT_NAME__AUTO_HEALTH_CHECK+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++true+++`

a| [[quarkus-langchain4j-mcp_quarkus-langchain4j-mcp-client-name-auto-health-check-interval]] [.property-path]##link:#quarkus-langchain4j-mcp_quarkus-langchain4j-mcp-client-name-auto-health-check-interval[`+++quarkus.langchain4j.mcp."client-name".auto-health-check-interval+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.langchain4j.mcp."client-name".auto-health-check-interval+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
The interval for automatic health checks (if enabled using the "autoHealthCheck" property). The default is 60 seconds.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_LANGCHAIN4J_MCP__CLIENT_NAME__AUTO_HEALTH_CHECK_INTERVAL+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_LANGCHAIN4J_MCP__CLIENT_NAME__AUTO_HEALTH_CHECK_INTERVAL+++`
endif::add-copy-button-to-env-var[]
--
|link:https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/time/Duration.html[Duration] link:#duration-note-anchor-all-config[icon:question-circle[title=More information about the Duration format]]
|`+++60S+++`

a| [[quarkus-langchain4j-mcp_quarkus-langchain4j-mcp-client-name-subsidiary-channel]] [.property-path]##link:#quarkus-langchain4j-mcp_quarkus-langchain4j-mcp-client-name-subsidiary-channel[`+++quarkus.langchain4j.mcp."client-name".subsidiary-channel+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.langchain4j.mcp."client-name".subsidiary-channel+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
Whether to open a subsidiary SSE channel for the streamable HTTP transport. When enabled, the transport will open a long-lived HTTP GET-based SSE stream after initialization, allowing the server to send notifications and requests to the client without the client first sending data via HTTP POST. This is useful for receiving server-initiated messages such as tool list change notifications. Only applies to MCP clients using the streamable HTTP transport.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_LANGCHAIN4J_MCP__CLIENT_NAME__SUBSIDIARY_CHANNEL+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_LANGCHAIN4J_MCP__CLIENT_NAME__SUBSIDIARY_CHANNEL+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++false+++`
...
This param is rejected by `gpt-image` models, which always return base64 data. When unset, the field is omitted from the request so those models are not affected.
...
Must be one of `1024x1024`, `1024x1536`, `1536x1024`, or `auto` when using `gpt-image` models.
...
For `dall-e-3`: `standard` or `hd`. For `dall-e-2`: `standard` only. For `gpt-image` models: `low`, `medium`, `high`, or `auto`.
...
[.description]
--
The background transparency of the generated image. Must be one of `transparent`, `opaque`, or `auto`. This param is only supported when using `gpt-image` models.
...
This param is only supported when the model is `dall-e-3`. When unset, the field is omitted from the request so other models are not affected.
